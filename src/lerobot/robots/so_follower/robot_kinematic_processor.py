"""
SO 机器人运动学处理器模块 (SO Robot Kinematic Processor Module)
==========================================================

本模块提供了用于 SO 系列机器人的运动学处理器。

主要组件:
    - EEReferenceAndDelta: 从相对增量命令计算目标末端执行器位姿
    - EEBoundsAndSafety: 将末端执行器位姿限制在安全边界内
    - InverseKinematicsRLStep: 逆运动学卂解
    - ForwardKinematicsJointsToEEObservation: 正运动学转换
    - GripperVelocityToJoint: 夹爦速度到关节位置转换
"""
